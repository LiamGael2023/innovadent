...
<div class="page-header d-print-none">
    <div class="row g-2 align-items-center">
        <div class="col">
            <h2 class="page-title">
                <i class="ti ti-tooth icon me-2"></i>
                Tratamientos
            </h2>
        </div>
    </div>
    ...
    <div class="container-xl d-flex flex-column justify-content-center">
        <div class="empty">
            ...
            <p class="empty-subtitle text-muted">
                El módulo de Tratamientos está actualmente en construcción. Pronto estará disponible para gestionar tratamientos dentales, precios y catálogos.
            </p>
