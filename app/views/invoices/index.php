...
<div class="page-header d-print-none">
    <div class="row g-2 align-items-center">
        <div class="col">
            <h2 class="page-title">
                <i class="ti ti-file-invoice icon me-2"></i>
                Facturación
            </h2>
        </div>
    </div>
    ...
    <div class="container-xl d-flex flex-column justify-content-center">
        <div class="empty">
            ...
            <p class="empty-subtitle text-muted">
                El módulo de Facturación está actualmente en construcción. Pronto podrás generar facturas, cotizaciones y llevar el control financiero de tu clínica.
            </p>
